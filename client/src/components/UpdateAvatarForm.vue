<template>
  <v-card class="mx-auto px-5 " align='center' justify='center' width='700' height="auto">
    ...
    <form >
      <v-file-input v-model='avatar' label="Images" @change="$v.avatar.$touch()" @blur="$v.avatar.$touch()" accept="image/*" prepend-icon="mdi-camera"></v-file-input>
...
export default {
  ...
  methods: {
    async handleSubmit(event) {
      ...
      const avatarBody = {avatar: this.avatar}
